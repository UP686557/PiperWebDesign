...
<html lang="en">
  <head>
    ...
    <title id=title>Piper Web Design | SEO Optimisation</title>
    <meta charset="utf-8">
  ...
  <body>
    ...
    <!-- <section id=about class=container-fluid> -->
      <div class="container border-bottom clearfix">
        <img src="Images/Text/seo.png" class="float-right title-image page-title"/>
      </div>
      ...
      <div class="container">
        <div class="row featurette">
          <div class="col-md-7 order-md-2 align-self-center">
            <h2 class="text-muted">SEO Optimisation</h2>
            <p class="lead"></p>
            <p class="lead"></p>
          </div>
        </div>
